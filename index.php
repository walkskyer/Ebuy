...
<?php } else { ?>
	<a href="<?php the_permalink() ?>"><img class="boximg" src="<?php bloginfo('template_directory'); ?>/images/dummy.png" width="150px" height="150px" alt="" /></a>
<?php } ?>
</div>
<div class="boxmeta clearfix">
<span class="p-cost"> &yen;<?php $cost=get_post_meta($post->ID, 'wtf_cost', true); echo $cost; ?> </span>
<span class="p-link"> <a href="<?php the_permalink() ?>">商品详情</a> </span>
</div>
</div>
<?php if(++$counter % 3 == 0) : ?>
<div class="clear"></div>
