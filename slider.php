...
<span class="s-cost">&yen;<?php $cost=get_post_meta($post->ID, 'wtf_cost', true); echo $cost; ?></span>
<span class="s-link"> <a href="<?php the_permalink() ?>">商品详情</a> </span>
</div>
</div>
</div>
