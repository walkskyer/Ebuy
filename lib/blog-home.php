...
<div class="postmeta">
	<span class="author">作者： <?php the_author(); ?> </span> <span class="clock">  <?php the_time('M - j - Y'); ?></span> <span class="comm"><?php comments_popup_link('0条评论', '1 条评论', '% 条评论'); ?></span>
</div>
...
<span class="category">评论: <?php the_category(', '); ?> </span>
</div>
</div>
